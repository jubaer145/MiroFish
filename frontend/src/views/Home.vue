    ...
    <div class=”main-content”>
      ...
      <section class=”hero-section”>
        <div class=”hero-left”>
          ...
          <div class=”hero-desc”>
            <p>
              Even with just a paragraph of text, <span class=”highlight-bold”>MiroFish</span> can automatically generate a parallel world of up to <span class=”highlight-orange”>Million-scale Agents</span> based on the seed material within. By injecting variables from a god's-eye view, it searches for <span class=”highlight-code”>”local optimal solutions”</span> within complex group interactions in dynamic environments.
            </p>
            <p class=”slogan-text”>
              Let the future be rehearsed among Agent swarms, let decisions win after a hundred battles<span class=”blinking-cursor”>_</span>
            </p>
          </div>
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Seed Material extraction & individual/group memory injection & GraphRAG construction</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter your simulation or prediction requirements in natural language (e.g. If Wuhan University issues an announcement revoking someone's disciplinary action, what public opinion trends would it trigger?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate immediately to the Process page (special identifier for new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Space Grotesk is used as the primary heading font; JetBrains Mono for code/label text.
